...
export async function CreateGame() {
    const result = await fetch(api_uri + '/create-game', {
        method: "POST"
    }); 
    if (result.ok) {
...
export async function RetrievePlayers(game_id: number) {
    const result = await fetch(api_uri + '/retrieve-players', {
        method: "POST",
...
async function RetrieveUser() {
    ...
    const result = await fetch(api_uri + '/retrieve-user', {
    method: "POST",
    headers: { 'Content-Type' : 'application/json' },
...
async function UpdateGame(new_state: string) {
    ...
    const result = await fetch(api_uri + '/update-game', {
        method: "POST",
        headers: { 'Content-Type' : 'application/json' },
...
export async function UpsertUser(email: string, access_token: string | undefined, refresh_token: string | undefined, spotify_user_id: string) {
    const result = await fetch(api_uri + '/upsert-user', {
        method: "PUT",
        headers: { 'Content-Type' : 'application/json' },
...
export async function UpsertPlayer(user_id: number, game_id: number, playlist_uri: string) {
    ...
    const result = await fetch(api_uri + '/upsert-player', {
        method: "PUT",
        headers: { 'Content-Type' : 'application/json' },
...
async function UpsertGuess(guessed_player_id: number) {
    ...
    const result = await fetch(api_uri + '/upsert-guess', {
        method: "PUT",
        headers: { 'Content-Type' : 'application/json' },
